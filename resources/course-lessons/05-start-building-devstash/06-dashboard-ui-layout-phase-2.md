...
In your resource files, you will have `context/features/dashboard-phase-2-spec.md`. Put that into your project's `context/features` folder.
...
```text
Update the @context/current-feature.md to add the feature from @context/features/dashboard-phase-2-spec.md and set the status to In Progress
```
